"""Tests for the 01 — Strategy demo.

Run:  ./lld/run_tests.sh                          # every LLD test
      .venv/bin/pytest lld/patterns/01_strategy -q   # this item alone

pytest puts this folder on sys.path, so `from strategy import X` resolves.
"""

...
- **Family:** Creational
- **Prerequisite items:** 01
- **Status:** not started

## The problem it solves

The caller must not know which concrete class it receives. Who decides, and where does that decision live?

## Why it sits at position 02

Item 01 leaves one question open: who picks the strategy? This answers it.

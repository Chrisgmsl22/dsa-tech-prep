"""Tests for the 07 — Chain of Responsibility demo.

Run:  ./lld/run_tests.sh                          # every LLD test
      .venv/bin/pytest lld/patterns/07_chain_of_responsibility -q   # this item alone

pytest puts this folder on sys.path, so `from chain_of_responsibility import X` resolves.
"""

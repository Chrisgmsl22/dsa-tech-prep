"""Tests for the 04 — Observer demo.

Run:  ./lld/run_tests.sh                          # every LLD test
      .venv/bin/pytest lld/patterns/04_observer -q   # this item alone

pytest puts this folder on sys.path, so `from observer import X` resolves.
"""

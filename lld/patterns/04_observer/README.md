...
- **Family:** Behavioral
- **Prerequisite items:** none, but 01 gives you the interface habit
- **Status:** not started

## The problem it solves

One event, many interested parties, and the source must not know who they are.

## Why it sits at position 04

A new axis. Items 01 to 03 change what an object does. This one changes who hears about it.

---

> Fill in the sections below **from memory**, after 10 minutes of reading at most.
> An article you read is not practice. This file is the artifact.

"""Tests for the 08 — Adapter demo.

Run:  ./lld/run_tests.sh                          # every LLD test
      .venv/bin/pytest lld/patterns/08_adapter -q   # this item alone

pytest puts this folder on sys.path, so `from adapter import X` resolves.
"""

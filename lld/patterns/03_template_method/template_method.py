"""03 — Template Method — minimal demo.

Rules for this file:
  - 40 lines or fewer. This is not an app.
  - No prints. `test_template_method.py` is how you check it.
...
# TODO: write the smallest code that shows the shape of Template Method.

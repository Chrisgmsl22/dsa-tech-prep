...
- **Family:** Structural
- **Prerequisite items:** 10
- **Status:** not started

## The problem it solves

A leaf and a container must answer the same calls, so a caller can treat them alike.

## Why it sits at position 12

It reuses item 10's "same interface" idea and applies it to a tree.

...
- **Family:** Structural
- **Prerequisite items:** 08
- **Status:** not started

## The problem it solves

Add behavior to 1 object, at run time, without a subclass.

## Why it sits at position 10

A wrap that keeps the same interface, so wraps nest. Compare it with item 08, which changes the interface on purpose.

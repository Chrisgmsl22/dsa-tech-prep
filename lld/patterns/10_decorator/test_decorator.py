"""Tests for the 10 — Decorator demo.

Run:  ./lld/run_tests.sh                          # every LLD test
      .venv/bin/pytest lld/patterns/10_decorator -q   # this item alone

pytest puts this folder on sys.path, so `from decorator import X` resolves.
"""
